...
public class BalanceTrainingActivity extends AppCompatActivity implements View.OnClickListener{
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.fragment_balance_training);
            init();
        ...
        public void onClick(View v) {
            ...
            {
                Intent L1 = new Intent(this, ARM_ExerciseOption.class);
                L1.putExtra(option_data,getResources().getString(R.string.Sitting));
                startActivity(L1);
            }
            else if(v.equals(findViewById(R.id.txt_L3)) )
            {
                Intent L3 = new Intent(this, ARM_ExerciseOption.class);
                L3.putExtra(option_data,getResources().getString(R.string.Standing));
                startActivity(L3);
            }
...
//        }
        ...
        private void setUpToolbar() {
            ...
            toolbarTitle.setText("Balance Training");
