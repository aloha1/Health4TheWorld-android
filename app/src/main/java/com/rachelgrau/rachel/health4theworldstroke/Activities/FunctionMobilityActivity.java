...
public class FunctionMobilityActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_functional_mobility);
        init();
    ...
    public void onClick(View v) {
        ...
        {
            Intent L1 = new Intent(this, videoPlayer.class);
            L1.putExtra(videoName, getString(R.string.Roll_in_bed));
            startActivity(L1);        }
        else if(v.equals(findViewById(R.id.txt_L3)) )
        {
            Intent L3 = new Intent(this, videoPlayer.class);
            L3.putExtra(videoName, getString(R.string.Roll_out_of_bed));
            startActivity(L3);
        }
...
//        }
    ...
    private void setUpToolbar() {
        ...
        toolbarTitle.setText("Function Mobility");
